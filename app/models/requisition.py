...
class Requisition(Base):
    ...
    documents = relationship("RequisitionDocument", back_populates="requisition", cascade="all, delete-orphan")
    retentions = relationship("RequisitionRetention", back_populates="requisition", cascade="all, delete-orphan")
